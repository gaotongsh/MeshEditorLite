...
class EdgeRecord {
 public:
  EdgeRecord() = default;
  explicit EdgeRecord(EdgeIter& _edge);
...
class Face : public HalfedgeElement {
 public:
   ...
   */
  explicit Face(bool isBoundary = false) : _isBoundary(isBoundary) {}
...
class HalfedgeMesh {
 public:
  ...
  Size nHalfedges() const { return halfedges.size(); }   ///< get the number of halfedges
  Size nVertices() const { return vertices.size(); }     ///< get the number of vertices
  Size nEdges() const { return edges.size(); }           ///< get the number of edges
  Size nFaces() const { return faces.size(); }           ///< get the number of faces
  Size nBoundaries() const { return boundaries.size(); } ///< get the number of boundaries
